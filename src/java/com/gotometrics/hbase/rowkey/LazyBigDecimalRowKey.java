...
/** Serializes and deserializes @{link BigDecimal} Objects into variable-length,
 * sortable byte array representations. The serialization method is identical
 ...
 * @{link BigDecimalRowKey#deserialize}, is used to deserialize
 * this byte array lazily on demand. This class allows <code>BigDecimal</code> 
 * objects to be lazily deserialized so that these objects are allocated only 
 * when required.
 *
 * <h1> Usage </h1>
 ...
 * multiple calls to the <code>getBigDecimal</code> method.
 */
